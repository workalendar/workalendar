...
of [semver](https://semver.org) for released verisons.

If you spot any bug or wish to add a calendar, please refer to the [Contributing doc](CONTRIBUTING.rst).
...
[the official workalendar documentation](https://peopledoc.github.io/workalendar).
...
Please read our [CONTRIBUTING.rst](https://github.com/jaraco/calandra/blob/master/CONTRIBUTING.rst)

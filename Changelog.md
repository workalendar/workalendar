...
- Remove `skyfield` dependency, added `[astronomy]` as extra dependency (#660). *See the README for more details, you may have to make changes to your installed packages in your environment.*

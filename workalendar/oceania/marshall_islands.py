...
class MarshallIslands(WesternCalendar, ChristianMixin):
    ...
    def get_variable_days(self, year):
        ...
        days.append(
            (MarshallIslands.get_nth_weekday_in_month(year, 9, FRI), "Labour Day")
        )
        days.append(
            (MarshallIslands.get_last_weekday_in_month(year, 9, FRI), "Manit Day")
        )
        days.append(
            (MarshallIslands.get_nth_weekday_in_month(year, 12, FRI), "Gospel Day")
        )
        return days

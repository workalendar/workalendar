...
class LateSummer(object):
    def get_variable_days(self, year):
        ...
        days.append(
            (self.get_nth_weekday_in_month(year, 9, MON), "Late Summer Holiday")
        )
        return days
...
class AyrGoldCup(object):
    def get_variable_days(self, year):
        ...
        days.append((gold_cup_friday, "Ayr Gold Cup Friday"))
        days.append((gold_cup_friday + timedelta(days=3), "Ayr Gold Cup Monday"))
        return days

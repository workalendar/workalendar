...
class China(ChineseNewYearCalendar, WesternCalendar):
    ...
    def is_working_day(self, day, extra_working_days=None, extra_holidays=None):
        ...
        return super(China, self).is_working_day(
            day, extra_working_days, extra_holidays
        )
    ...
    def add_working_days(
        ...
        extra_working_days = extra_working_days or self.extra_working_days
        return super(China, self).add_working_days(
            day, delta, extra_working_days, extra_holidays, keep_datetime
        )
    ...
    def sub_working_days(
        ...
        extra_working_days = extra_working_days or self.extra_working_days
        return super(China, self).sub_working_days(
            day, delta, extra_working_days, extra_holidays, keep_datetime
        )

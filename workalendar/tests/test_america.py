...
class ElSalvadorTest(GenericCalendarTest):
    ...
    def test_holidays_2018(self):
        ...
        self.assertIn(date(2018, 8, 6), holidays)   # Celebrations of San Salvador
    ...
    def test_holidays_2019(self):
        ...
        self.assertIn(date(2019, 8, 6), holidays)   # Celebrations of San Salvador
    ...
    def test_holidays_2020(self):
        ...
        self.assertIn(date(2020, 8, 6), holidays)   # Celebrations of San Salvador
    ...
    def test_holidays_2021(self):
        ...
        self.assertIn(date(2021, 8, 6), holidays)   # Celebrations of San Salvador
